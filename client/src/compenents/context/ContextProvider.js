...
const ContextProvider = ({ children }) => {
    const [udata, setUdata] = useState(null); // Change "" to null
    const [updata, setUPdata] = useState(null); // Change "" to null
    const [dltdata, setDLTdata] = useState(null); // Change "" to null
